package com.sydt.common.config;
...
import com.sydt.common.utils.YamlUtil;
...
public class Global
{
    ...
    {
        System.out.println(getConfig("numberone.profile") + "avatar/");
    ...
    {
        return StringUtils.nvl(getConfig("gen.packageName"), "com.sydt.project.module");
    }
